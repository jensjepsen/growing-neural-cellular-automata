...
In their work, the authors show how to **learn** the update function of a cellular automata (CA), in such a way, that the cells grow into an arbitrary image, that can regenerate if parts of it are destroyed. Amazing!
